        ...
        const fetchDifficultyAndQuiz = async () => {
            ...
            try {
                ...
                if (quizRes.data.data.questions) {
                    ...
                    const isHardAndCompleted =
                        fetchedQuiz.difficulty === "Hard" &&
                        fetchedQuiz.latest_quiz_attempt?.completed_at != null;

                    if (isHardAndCompleted) {
                        // Hard quiz already done — show all results view
                        setAvailableQuiz(null);
                        setShowAllQuizzes(true);
                        setAllQuizzes({});
                    } else {
                        setAvailableQuiz(fetchedQuiz);
